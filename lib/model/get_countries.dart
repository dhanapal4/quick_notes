...
List<GetCountries> getCountriesFromJson(String str) => List<GetCountries>.from(
    json.decode(str).map((x) => GetCountries.fromJson(x)));

String getCountriesToJson(List<GetCountries> data) =>
...
class GetCountries {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "latlng": List<int>.from(latlng.map((x) => x)),
        "demonym": demonym,
        "area": area,
        "gini": gini,
